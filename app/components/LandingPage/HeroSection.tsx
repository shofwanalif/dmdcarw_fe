...
export default function HeroSection() {
  return (
    <section className="relative md:pt-0">
          ...
          <div className="max-w-3xl flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link href="#services" className="w-full sm:w-auto">
                <button className="flex items-center justify-center rounded-lg h-12 px-8 bg-primary hover:bg-blue-600 text-white text-base font-bold transition-all transform hover:scale-105 shadow-lg shadow-primary/30 cursor-pointer w-full">
                  Lihat layanan
                </button>
              </Link>
